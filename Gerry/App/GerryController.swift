    ...
    init() {
        DispatchQueue.main.async {
            Task {
                ...
                ExportView(videoURL: URL(string: "file:///var/folders/p3/rnrgknms7c72zcxt79p8dw440000gn/T/me.brunson.Gerry/0198E00D-1B07-43A8-A252-90CB6C0EE9B1.mp4")!).openNewWindow(title: "Gerry - Save", contentRect: CGRect(x: 0, y: 0, width: display.width, height: display.height-400))
            }
        }
